...
// ─── DESIGN TOKENS (Manteis Design Standard) ────────────────────────────────
const C = {
  bg: "#0D0F12",
  surface: "#15181E",
  text: "#F4F3EE",
      ...
      <div className="relative z-10 max-w-7xl mx-auto min-h-[calc(100vh-56px)] grid grid-cols-12 gap-0">
        ...
        >
          ...
          <motion.p
            ...
            style={{ color: C.muted }}
          >
            Local-first AI infrastructure. One command. Zero cloud. Deploy inference, memory,
            automation, fleet management, and security on hardware you own.
          </motion.p>
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-12 gap-0">
        ...
        <div className="col-span-12 md:col-span-9 p-6 md:p-10 border-b" style={{ borderColor: C.border }}>
          ...
          <p className="font-body text-lg leading-[1.65] max-w-[65ch] mt-4" style={{ color: C.muted }}>
            Sovereign OS unifies inference, memory, automation, fleet operations, security, and
            knowledge into a single local-first control plane.
          </p>
        </div>
      </div>
    ...
    <section id="architecture" className="relative border-t" style={{ background: C.bg, borderColor: C.border }}>
      <div className="max-w-7xl mx-auto grid grid-cols-12 gap-0">
        ...
        <div className="col-span-12 md:col-span-9 p-6 md:p-10 border-b" style={{ borderColor: C.border }}>
          ...
          <p className="font-body text-lg leading-[1.65] max-w-[65ch] mt-4" style={{ color: C.muted }}>
            A vertical stack designed for sovereignty: compute stays local, storage stays encrypted,
            orchestration stays programmable, and integrations stay under your policies.
          </p>
        </div>
      </div>
...
function Pricing() {
  const tiers = [
    {
      icon: Zap,
      name: "Starter",
      tagline: "Pilot & proof-of-concept",
      price: "$15K",
      range: "$15,000 – $50,000",
      accent: C.blue,
      specs: [
        "Single workflow deployment",
        "Compact hardware (Mac Mini / NUC class)",
        "Up to 5 users",
    ...
    },
    {
      icon: Building2,
      name: "Standard",
      tagline: "Multi-workflow deployment",
      price: "$50K",
      ...
      specs: [
        ...
        "Professional hardware (tower workstation)",
        "5–20 users",
        "90-day post-deployment support",
        "Custom agent development",
        "Security hardening & SIEM setup",
        "Quarterly health checks (1 year)",
      ],
      cta: "Book a discovery call",
    },
    {
      ...
      accent: C.blue,
      specs: [
        "Full sovereign stack deployment",
        "Enterprise hardware (rack cluster)",
        "50+ users",
        "Dedicated support SLA",
        "Custom integrations (ERP, CRM, DAM)",
  ...
  return (
    <section id="pricing" className="relative border-t" style={{ background: C.bg, borderColor: C.border }}>
      <div className="max-w-7xl mx-auto grid grid-cols-12 gap-0">
        ...
        <div className="col-span-12 md:col-span-9 p-6 md:p-10 border-b" style={{ borderColor: C.border }}>
          <h2
            ...
            style={{ color: C.text }}
          >
            Three tiers. Your scope.
          </h2>
          <p className="font-body text-lg leading-[1.65] max-w-[65ch] mt-4" style={{ color: C.muted }}>
            Every deployment is scoped to your budget, timeline, and requirements. These ranges
            represent typical engagements — we build solutions that fit, not packages that don&apos;t.
          </p>
        </div>
      </div>
      ...
      >
        {tiers.map((tier) => (
          ...
          >
            ...
            <p className="font-mono text-[11px] tracking-wide mb-6" style={{ color: C.muted }}>
              {tier.range}
            </p>
            ...
            <a
              href="mailto:rhett@manteis.systems?subject=Sovereign%20OS%20-%20{tier.name}%20Tier"
      ...
      {/* Payment terms note */}
      <div className="max-w-7xl mx-auto px-6 md:px-10 py-8 border-t" style={{ borderColor: C.border }}>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div>
            <span className="font-mono text-[10px] tracking-[0.12em] uppercase block mb-2" style={{ color: C.muted }}>
              Implementation
            </span>
            <span className="font-body text-[14px]" style={{ color: C.text }}>
              50% deposit · 25% milestone · 25% completion
            </span>
          </div>
          <div>
            <span className="font-mono text-[10px] tracking-[0.12em] uppercase block mb-2" style={{ color: C.muted }}>
          ...
          <div>
            ...
            <span className="font-body text-[14px]" style={{ color: C.text }}>
              $1K – $15K/month — Essential to Enterprise
            </span>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-12 gap-0">
        ...
        >
          ...
          <p className="font-body text-lg leading-[1.65] max-w-[50ch]" style={{ color: C.muted }}>
            One command installs the entire Sovereign OS stack on a fresh Linux host. No cloud
            accounts. No API keys. No data leaving your network.
          </p>
        </div>
        ...
        <div className="col-span-12 md:col-span-7 p-6 md:p-10 flex flex-col justify-center">
          ...
          <motion.div
            ...
            className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-px border"
          ...
          >
            <Link
              ...
              style={{ background: C.signal, color: C.bg }}
            >
              Get a Sovereign AI Assessment <ArrowRight size={16} />
            </Link>
